      ...
      <div className="bg-surface rounded-2xl shadow-xl border border-border p-8 max-w-2xl w-full relative z-10">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-4">
            <div className="shrink-0 bg-transparent p-1">
              <img src="/postboy-logo.png" alt="" className={`h-16 w-auto max-w-[240px] object-contain ${theme === 'dark' ? '[mix-blend-mode:screen]' : ''}`} aria-hidden />
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-primary text-on-primary py-2.5 px-4 rounded-xl text-base font-medium hover:bg-primary-hover disabled:opacity-50 disabled:bg-surface-secondary shadow-sm hover:shadow transition-all duration-200"
              >
                Create
              </button>
              <button
